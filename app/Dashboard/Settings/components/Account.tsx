  ...
  return (
    <div className="space-y-6 dark:bg-[#09090B]">
      ...
      <div className="space-y-3 dark:text-white">
        ...
        <p className="text-xs text-gray-500"> <span className="text-blue-500 cursor-pointer">Add photo</span> or <span className="text-red-500 cursor-pointer">Remove photo</span></p>
      </div>
      ...
      <div className="flex items-center gap-2 justify-between">
        ...
        <button
          ...
          className="whitespace-nowrap px-3 w-60 py-2 bg-red-600 text-white text-[12px] rounded-md hover:bg-red-700 transition-colors"
        >
          Disable account
        </button>
      </div>
      ...
      <DisableAccountDialog open={disableAccountOpen} onOpenChange={setDisableAccountOpen} />
    </div>
  );
}
